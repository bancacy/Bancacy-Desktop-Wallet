    ...
    <div class="flex p-4">
      ...
      <div class="w-3/4 flex-no-grow pl-4">
        <div class="bg-white rounded border border-grey-light px-4 pt-2 pb-6 mb-4">
          <div class="text-grey-darker font-bold text-sm border-b border-grey-light pb-1">Settings: Export Private Key</div>
          <div class="mt-4">
  ...
  export default {
    ...
    components: { WalletHeader, ButtonMenu },
      ...
      getPrivateKey: async function () {
        ...
        walletKeystore.getPrivateKey(this.password, this.walletAddress, (key) => {
          this.privateKey = key;
        });
      }
  	}
